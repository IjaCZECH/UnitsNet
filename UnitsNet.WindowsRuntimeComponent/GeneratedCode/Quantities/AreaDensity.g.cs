...
namespace UnitsNet
{
    ...
    public sealed partial class AreaDensity : IQuantity
    {
        ...
        private AreaDensity(decimal value, AreaDensityUnit unit)
        {
        ...
        public static AreaDensity FromKilogramsPerSquareMeter(decimal kilogramspersquaremeter)
        {
        ...
        public static AreaDensity From(decimal value, AreaDensityUnit fromUnit)
        {
        ...
        decimal IQuantity.As(object unit) => As((AreaDensityUnit)unit);
        ...
        private decimal AsBaseNumericType(AreaDensityUnit unit)
        {
            if(Unit == unit)
                return _value;
