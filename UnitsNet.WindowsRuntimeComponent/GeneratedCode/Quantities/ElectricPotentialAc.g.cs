...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricPotentialAc : IQuantity
    {
        ...
        private ElectricPotentialAc(decimal value, ElectricPotentialAcUnit unit)
        {
        ...
        public static ElectricPotentialAc From(decimal value, ElectricPotentialAcUnit fromUnit)
        {
        ...
        decimal IQuantity.As(object unit) => As((ElectricPotentialAcUnit)unit);
        ...
        private decimal AsBaseNumericType(ElectricPotentialAcUnit unit)
        {
            if(Unit == unit)
                return _value;
