...
namespace UnitsNet
{
    ...
    public sealed partial class LuminousFlux : IQuantity
    {
        ...
        private LuminousFlux(decimal value, LuminousFluxUnit unit)
        {
        ...
        public static LuminousFlux FromLumens(decimal lumens)
        {
        ...
        public static LuminousFlux From(decimal value, LuminousFluxUnit fromUnit)
        {
        ...
        internal int CompareTo(LuminousFlux other)
        {
        ...
        decimal IQuantity.As(object unit) => As((LuminousFluxUnit)unit);
        ...
        private decimal AsBaseNumericType(LuminousFluxUnit unit)
        {
            if(Unit == unit)
                return _value;
