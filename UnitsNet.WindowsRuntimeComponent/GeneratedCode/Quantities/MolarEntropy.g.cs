...
namespace UnitsNet
{
    ...
    public sealed partial class MolarEntropy : IQuantity
    {
        ...
        private MolarEntropy(decimal value, MolarEntropyUnit unit)
        {
        ...
        public static MolarEntropy From(decimal value, MolarEntropyUnit fromUnit)
        {
        ...
        decimal IQuantity.As(object unit) => As((MolarEntropyUnit)unit);
        ...
        private decimal AsBaseNumericType(MolarEntropyUnit unit)
        {
            if(Unit == unit)
                return _value;
