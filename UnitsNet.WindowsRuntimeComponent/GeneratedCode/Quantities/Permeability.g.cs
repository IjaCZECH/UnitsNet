...
namespace UnitsNet
{
    ...
    public sealed partial class Permeability : IQuantity
    {
        ...
        private Permeability(decimal value, PermeabilityUnit unit)
        {
        ...
        public static Permeability FromHenriesPerMeter(decimal henriespermeter)
        {
        ...
        public static Permeability From(decimal value, PermeabilityUnit fromUnit)
        {
        ...
        decimal IQuantity.As(object unit) => As((PermeabilityUnit)unit);
        ...
        private decimal AsBaseNumericType(PermeabilityUnit unit)
        {
            if(Unit == unit)
                return _value;
