...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricField : IQuantity
    {
        ...
        private ElectricField(decimal value, ElectricFieldUnit unit)
        {
        ...
        public static ElectricField FromVoltsPerMeter(decimal voltspermeter)
        {
        ...
        public static ElectricField From(decimal value, ElectricFieldUnit fromUnit)
        {
        ...
        internal int CompareTo(ElectricField other)
        {
        ...
        decimal IQuantity.As(object unit) => As((ElectricFieldUnit)unit);
        ...
        private decimal AsBaseNumericType(ElectricFieldUnit unit)
        {
            if(Unit == unit)
                return _value;
