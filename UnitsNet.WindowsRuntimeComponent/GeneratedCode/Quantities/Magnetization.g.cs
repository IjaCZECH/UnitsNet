...
namespace UnitsNet
{
    ...
    public sealed partial class Magnetization : IQuantity
    {
        ...
        private Magnetization(decimal value, MagnetizationUnit unit)
        {
        ...
        public static Magnetization FromAmperesPerMeter(decimal amperespermeter)
        {
        ...
        public static Magnetization From(decimal value, MagnetizationUnit fromUnit)
        {
        ...
        decimal IQuantity.As(object unit) => As((MagnetizationUnit)unit);
        ...
        private decimal AsBaseNumericType(MagnetizationUnit unit)
        {
            if(Unit == unit)
                return _value;
