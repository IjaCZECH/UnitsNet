...
namespace UnitsNet
{
    ...
    public sealed partial class RatioChangeRate : IQuantity
    {
        /// <summary>
        ...
        public static RatioChangeRate FromDecimalFractionsPerSecond(decimal decimalfractionspersecond)
        {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static RatioChangeRate FromPercentsPerSecond(decimal percentspersecond)
        {
        ...
        /// </exception>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static RatioChangeRate Parse(string str, [CanBeNull] string cultureName)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        /// </example>
        /// <param name="cultureName">Name of culture (ex: "en-US") to use when parsing number and unit. Defaults to <see cref="GlobalConfiguration.DefaultCulture" /> if null.</param>
        public static bool TryParse([CanBeNull] string str, [CanBeNull] string cultureName, out RatioChangeRate result)
        {
            IFormatProvider provider = GetFormatProviderFromCultureName(cultureName);
        ...
        internal int CompareTo(RatioChangeRate other)
        {
        ...
        decimal IQuantity.As(object unit) => As((RatioChangeRateUnit)unit);
        ...
        private decimal AsBaseNumericType(RatioChangeRateUnit unit)
        {
            if(Unit == unit)
                return _value;
