...
namespace UnitsNet
{
    ...
    public sealed partial class MagneticFlux : IQuantity
    {
        ...
        private MagneticFlux(decimal value, MagneticFluxUnit unit)
        {
        ...
        public static MagneticFlux FromWebers(decimal webers)
        {
        ...
        public static MagneticFlux From(decimal value, MagneticFluxUnit fromUnit)
        {
        ...
        internal int CompareTo(MagneticFlux other)
        {
        ...
        decimal IQuantity.As(object unit) => As((MagneticFluxUnit)unit);
        ...
        private decimal AsBaseNumericType(MagneticFluxUnit unit)
        {
            if(Unit == unit)
                return _value;
