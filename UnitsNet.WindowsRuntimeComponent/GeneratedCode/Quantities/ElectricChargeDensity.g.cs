...
namespace UnitsNet
{
    ...
    public sealed partial class ElectricChargeDensity : IQuantity
    {
        ...
        private ElectricChargeDensity(decimal value, ElectricChargeDensityUnit unit)
        {
        ...
        public static ElectricChargeDensity FromCoulombsPerCubicMeter(decimal coulombspercubicmeter)
        {
        ...
        public static ElectricChargeDensity From(decimal value, ElectricChargeDensityUnit fromUnit)
        {
        ...
        decimal IQuantity.As(object unit) => As((ElectricChargeDensityUnit)unit);
        ...
        private decimal AsBaseNumericType(ElectricChargeDensityUnit unit)
        {
            if(Unit == unit)
                return _value;
