...
namespace UnitsNet
{
    ...
    public sealed partial class Level : IQuantity
    {
        ...
        private Level(decimal value, LevelUnit unit)
        {
        ...
        public static Level From(decimal value, LevelUnit fromUnit)
        {
        ...
        internal int CompareTo(Level other)
        {
        ...
        decimal IQuantity.As(object unit) => As((LevelUnit)unit);
        ...
        private decimal AsBaseNumericType(LevelUnit unit)
        {
            if(Unit == unit)
                return _value;
