...
namespace UnitsNet
{
    ...
    public sealed partial class Permittivity : IQuantity
    {
        ...
        private Permittivity(decimal value, PermittivityUnit unit)
        {
        ...
        public static Permittivity FromFaradsPerMeter(decimal faradspermeter)
        {
        ...
        public static Permittivity From(decimal value, PermittivityUnit fromUnit)
        {
        ...
        internal int CompareTo(Permittivity other)
        {
        ...
        decimal IQuantity.As(object unit) => As((PermittivityUnit)unit);
        ...
        private decimal AsBaseNumericType(PermittivityUnit unit)
        {
            if(Unit == unit)
                return _value;
