...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<Duration>(Duration.BaseUnit, DurationUnit.Month30m, q => q.ToUnit(DurationUnit.Month30m));
            unitConverter.SetConversionFunction<Duration>(DurationUnit.Month30m, Duration.BaseUnit, q => q.ToBaseUnit());
            ...
            unitConverter.SetConversionFunction<Duration>(Duration.BaseUnit, DurationUnit.Year365m, q => q.ToUnit(DurationUnit.Year365m));
            unitConverter.SetConversionFunction<Duration>(DurationUnit.Year365m, Duration.BaseUnit, q => q.ToBaseUnit());
