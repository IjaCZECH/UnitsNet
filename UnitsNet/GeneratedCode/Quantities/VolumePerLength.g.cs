...
namespace UnitsNet
{
    ...
    public partial struct VolumePerLength : IQuantity<VolumePerLengthUnit>, IEquatable<VolumePerLength>, IComparable, IComparable<VolumePerLength>, IConvertible, IFormattable
    {
        ...
        public VolumePerLength(decimal value, VolumePerLengthUnit unit)
        {
        ...
        public VolumePerLength(decimal value, UnitSystem unitSystem)
        {
        ...
        public static VolumePerLength operator *(decimal left, VolumePerLength right)
        {
            return new VolumePerLength(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="VolumePerLength"/> from multiplying value and <see cref="VolumePerLength"/>.</summary>
        public static VolumePerLength operator *(VolumePerLength left, decimal right)
        {
        ...
        public static decimal operator /(VolumePerLength left, VolumePerLength right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(VolumePerLength, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(VolumePerLength left, VolumePerLength right)
        {
        ...
        private decimal GetValueAs(VolumePerLengthUnit unit)
        {
            if(Unit == unit)
                return _value;
