...
namespace UnitsNet
{
    ...
    public partial struct MagneticFlux : IQuantity<MagneticFluxUnit>, IEquatable<MagneticFlux>, IComparable, IComparable<MagneticFlux>, IConvertible, IFormattable
    {
        ...
        public MagneticFlux(decimal value, MagneticFluxUnit unit)
        {
        ...
        public MagneticFlux(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static MagneticFlux MaxValue { get; } = new MagneticFlux(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of MagneticFlux
        /// </summary>
        public static MagneticFlux MinValue { get; } = new MagneticFlux(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal Webers => As(MagneticFluxUnit.Weber);
        ...
        {
            return new MagneticFlux((decimal)value, fromUnit);
        }
        ...
        public static MagneticFlux operator *(decimal left, MagneticFlux right)
        {
            return new MagneticFlux(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="MagneticFlux"/> from multiplying value and <see cref="MagneticFlux"/>.</summary>
        public static MagneticFlux operator *(MagneticFlux left, decimal right)
        {
        ...
        public static decimal operator /(MagneticFlux left, MagneticFlux right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(MagneticFlux, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(MagneticFlux left, MagneticFlux right)
        {
        ...
        public bool Equals(MagneticFlux other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        public decimal As(MagneticFluxUnit unit)
        {
            if(Unit == unit)
        ...
        private decimal GetValueAs(MagneticFluxUnit unit)
        {
            if(Unit == unit)
                return _value;
