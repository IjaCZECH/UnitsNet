...
namespace UnitsNet
{
    ...
    public partial struct Permittivity : IQuantity<PermittivityUnit>, IEquatable<Permittivity>, IComparable, IComparable<Permittivity>, IConvertible, IFormattable
    {
        ...
        public Permittivity(decimal value, PermittivityUnit unit)
        {
        ...
        public Permittivity(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static Permittivity MaxValue { get; } = new Permittivity(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Permittivity
        /// </summary>
        public static Permittivity MinValue { get; } = new Permittivity(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal FaradsPerMeter => As(PermittivityUnit.FaradPerMeter);
        ...
        {
            decimal value = (decimal) faradspermeter;
        ...
        {
            return new Permittivity((decimal)value, fromUnit);
        }
        ...
        public static Permittivity operator *(decimal left, Permittivity right)
        {
            return new Permittivity(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="Permittivity"/> from multiplying value and <see cref="Permittivity"/>.</summary>
        public static Permittivity operator *(Permittivity left, decimal right)
        {
        ...
        public static decimal operator /(Permittivity left, Permittivity right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(Permittivity, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(Permittivity left, Permittivity right)
        {
        ...
        public bool Equals(Permittivity other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        public decimal As(PermittivityUnit unit)
        {
            if(Unit == unit)
        ...
        private decimal GetValueAs(PermittivityUnit unit)
        {
            if(Unit == unit)
                return _value;
