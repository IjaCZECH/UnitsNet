...
namespace UnitsNet
{
    ...
    public partial struct MassMomentOfInertia : IQuantity<MassMomentOfInertiaUnit>, IEquatable<MassMomentOfInertia>, IComparable, IComparable<MassMomentOfInertia>, IConvertible, IFormattable
    {
        ...
        public MassMomentOfInertia(decimal value, MassMomentOfInertiaUnit unit)
        {
        ...
        public MassMomentOfInertia(decimal value, UnitSystem unitSystem)
        {
        ...
        public static MassMomentOfInertia operator *(decimal left, MassMomentOfInertia right)
        {
            return new MassMomentOfInertia(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="MassMomentOfInertia"/> from multiplying value and <see cref="MassMomentOfInertia"/>.</summary>
        public static MassMomentOfInertia operator *(MassMomentOfInertia left, decimal right)
        {
        ...
        public static decimal operator /(MassMomentOfInertia left, MassMomentOfInertia right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(MassMomentOfInertia, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(MassMomentOfInertia left, MassMomentOfInertia right)
        {
        ...
        private decimal GetValueAs(MassMomentOfInertiaUnit unit)
        {
            if(Unit == unit)
                return _value;
