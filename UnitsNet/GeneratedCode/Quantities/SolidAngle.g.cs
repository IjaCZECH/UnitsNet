...
namespace UnitsNet
{
    ...
    public partial struct SolidAngle : IQuantity<SolidAngleUnit>, IEquatable<SolidAngle>, IComparable, IComparable<SolidAngle>, IConvertible, IFormattable
    {
        ...
        public SolidAngle(decimal value, SolidAngleUnit unit)
        {
        ...
        public SolidAngle(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static SolidAngle MaxValue { get; } = new SolidAngle(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of SolidAngle
        /// </summary>
        public static SolidAngle MinValue { get; } = new SolidAngle(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal Steradians => As(SolidAngleUnit.Steradian);
        ...
        {
            decimal value = (decimal) steradians;
        ...
        {
            return new SolidAngle((decimal)value, fromUnit);
        }
        ...
        public static SolidAngle operator *(decimal left, SolidAngle right)
        {
            return new SolidAngle(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="SolidAngle"/> from multiplying value and <see cref="SolidAngle"/>.</summary>
        public static SolidAngle operator *(SolidAngle left, decimal right)
        {
        ...
        public static decimal operator /(SolidAngle left, SolidAngle right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(SolidAngle, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(SolidAngle left, SolidAngle right)
        {
        ...
        public bool Equals(SolidAngle other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        public decimal As(SolidAngleUnit unit)
        {
            if(Unit == unit)
        ...
        private decimal GetValueAs(SolidAngleUnit unit)
        {
            if(Unit == unit)
                return _value;
