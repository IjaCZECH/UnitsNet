...
namespace UnitsNet
{
    ...
    public partial struct LuminousIntensity : IQuantity<LuminousIntensityUnit>, IEquatable<LuminousIntensity>, IComparable, IComparable<LuminousIntensity>, IConvertible, IFormattable
    {
        ...
        public LuminousIntensity(decimal value, LuminousIntensityUnit unit)
        {
        ...
        public LuminousIntensity(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static LuminousIntensity MaxValue { get; } = new LuminousIntensity(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of LuminousIntensity
        /// </summary>
        public static LuminousIntensity MinValue { get; } = new LuminousIntensity(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal Candela => As(LuminousIntensityUnit.Candela);
        ...
        {
            return new LuminousIntensity((decimal)value, fromUnit);
        }
        ...
        public static LuminousIntensity operator *(decimal left, LuminousIntensity right)
        {
            return new LuminousIntensity(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="LuminousIntensity"/> from multiplying value and <see cref="LuminousIntensity"/>.</summary>
        public static LuminousIntensity operator *(LuminousIntensity left, decimal right)
        {
        ...
        public static decimal operator /(LuminousIntensity left, LuminousIntensity right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(LuminousIntensity, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(LuminousIntensity left, LuminousIntensity right)
        {
        ...
        public bool Equals(LuminousIntensity other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        public decimal As(LuminousIntensityUnit unit)
        {
            if(Unit == unit)
        ...
        private decimal GetValueAs(LuminousIntensityUnit unit)
        {
            if(Unit == unit)
                return _value;
