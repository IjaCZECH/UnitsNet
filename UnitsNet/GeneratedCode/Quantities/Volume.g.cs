...
namespace UnitsNet
{
    ...
    public partial struct Volume : IQuantity<VolumeUnit>, IEquatable<Volume>, IComparable, IComparable<Volume>, IConvertible, IFormattable
    {
        ...
        public Volume(decimal value, UnitSystem unitSystem)
        {
        ...
        public static Volume operator *(decimal left, Volume right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(Volume, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(Volume left, Volume right)
        {
        ...
        private decimal GetValueAs(VolumeUnit unit)
        {
            if (Unit == unit)
                return _value;
            ...
            switch (unit)
            {
                ...
                case VolumeUnit.CubicInch: return baseUnitValue / (1.6387m * 1e-5m);
