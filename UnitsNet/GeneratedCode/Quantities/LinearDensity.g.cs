...
namespace UnitsNet
{
    ...
    public partial struct LinearDensity : IQuantity<LinearDensityUnit>, IEquatable<LinearDensity>, IComparable, IComparable<LinearDensity>, IConvertible, IFormattable
    {
        ...
        public LinearDensity(decimal value, UnitSystem unitSystem)
        {
        ...
        public static LinearDensity operator *(decimal left, LinearDensity right)
        {
            return new LinearDensity(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="LinearDensity"/> from multiplying value and <see cref="LinearDensity"/>.</summary>
        public static LinearDensity operator *(LinearDensity left, decimal right)
        {
        ...
        public static decimal operator /(LinearDensity left, LinearDensity right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(LinearDensity, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(LinearDensity left, LinearDensity right)
        {
        ...
        private decimal GetValueAs(LinearDensityUnit unit)
        {
            if(Unit == unit)
                return _value;
