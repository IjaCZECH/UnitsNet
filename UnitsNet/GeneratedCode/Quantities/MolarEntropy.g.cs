...
namespace UnitsNet
{
    ...
    public partial struct MolarEntropy : IQuantity<MolarEntropyUnit>, IEquatable<MolarEntropy>, IComparable, IComparable<MolarEntropy>, IConvertible, IFormattable
    {
        ...
        public MolarEntropy(decimal value, MolarEntropyUnit unit)
        {
        ...
        public MolarEntropy(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static MolarEntropy MaxValue { get; } = new MolarEntropy(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of MolarEntropy
        /// </summary>
        public static MolarEntropy MinValue { get; } = new MolarEntropy(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal JoulesPerMoleKelvin => As(MolarEntropyUnit.JoulePerMoleKelvin);

        /// <summary>
        ///     Get MolarEntropy in KilojoulesPerMoleKelvin.
        /// </summary>
        public decimal KilojoulesPerMoleKelvin => As(MolarEntropyUnit.KilojoulePerMoleKelvin);

        /// <summary>
        ///     Get MolarEntropy in MegajoulesPerMoleKelvin.
        /// </summary>
        public decimal MegajoulesPerMoleKelvin => As(MolarEntropyUnit.MegajoulePerMoleKelvin);
        ...
        {
            decimal value = (decimal) joulespermolekelvin;
        ...
        {
            decimal value = (decimal) kilojoulespermolekelvin;
        ...
        {
            decimal value = (decimal) megajoulespermolekelvin;
        ...
        {
            return new MolarEntropy((decimal)value, fromUnit);
        }
        ...
        public static MolarEntropy operator *(decimal left, MolarEntropy right)
        {
            return new MolarEntropy(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="MolarEntropy"/> from multiplying value and <see cref="MolarEntropy"/>.</summary>
        public static MolarEntropy operator *(MolarEntropy left, decimal right)
        {
        ...
        public static decimal operator /(MolarEntropy left, MolarEntropy right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(MolarEntropy, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(MolarEntropy left, MolarEntropy right)
        {
        ...
        public bool Equals(MolarEntropy other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        public decimal As(MolarEntropyUnit unit)
        {
            if(Unit == unit)
        ...
        private decimal GetValueInBaseUnit()
        {
            switch(Unit)
            {
                ...
                case MolarEntropyUnit.KilojoulePerMoleKelvin: return (_value) * 1e3m;
                case MolarEntropyUnit.MegajoulePerMoleKelvin: return (_value) * 1e6m;
                default:
        ...
        private decimal GetValueAs(MolarEntropyUnit unit)
        {
            if(Unit == unit)
                return _value;
            ...
            switch(unit)
            {
                ...
                case MolarEntropyUnit.KilojoulePerMoleKelvin: return (baseUnitValue) / 1e3m;
                case MolarEntropyUnit.MegajoulePerMoleKelvin: return (baseUnitValue) / 1e6m;
                default:
