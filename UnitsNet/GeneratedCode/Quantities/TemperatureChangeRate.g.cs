...
namespace UnitsNet
{
    ...
    public partial struct TemperatureChangeRate : IQuantity<TemperatureChangeRateUnit>, IEquatable<TemperatureChangeRate>, IComparable, IComparable<TemperatureChangeRate>, IConvertible, IFormattable
    {
        ...
        public TemperatureChangeRate(decimal value, TemperatureChangeRateUnit unit)
        {
        ...
        public TemperatureChangeRate(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static TemperatureChangeRate MaxValue { get; } = new TemperatureChangeRate(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of TemperatureChangeRate
        /// </summary>
        public static TemperatureChangeRate MinValue { get; } = new TemperatureChangeRate(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal CentidegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.CentidegreeCelsiusPerSecond);

        /// <summary>
        ///     Get TemperatureChangeRate in DecadegreesCelsiusPerSecond.
        /// </summary>
        public decimal DecadegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.DecadegreeCelsiusPerSecond);

        /// <summary>
        ///     Get TemperatureChangeRate in DecidegreesCelsiusPerSecond.
        /// </summary>
        public decimal DecidegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.DecidegreeCelsiusPerSecond);

        /// <summary>
        ///     Get TemperatureChangeRate in DegreesCelsiusPerMinute.
        /// </summary>
        public decimal DegreesCelsiusPerMinute => As(TemperatureChangeRateUnit.DegreeCelsiusPerMinute);

        /// <summary>
        ///     Get TemperatureChangeRate in DegreesCelsiusPerSecond.
        /// </summary>
        public decimal DegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.DegreeCelsiusPerSecond);

        /// <summary>
        ///     Get TemperatureChangeRate in HectodegreesCelsiusPerSecond.
        /// </summary>
        public decimal HectodegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.HectodegreeCelsiusPerSecond);

        /// <summary>
        ///     Get TemperatureChangeRate in KilodegreesCelsiusPerSecond.
        /// </summary>
        public decimal KilodegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.KilodegreeCelsiusPerSecond);

        /// <summary>
        ///     Get TemperatureChangeRate in MicrodegreesCelsiusPerSecond.
        /// </summary>
        public decimal MicrodegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.MicrodegreeCelsiusPerSecond);

        /// <summary>
        ///     Get TemperatureChangeRate in MillidegreesCelsiusPerSecond.
        /// </summary>
        public decimal MillidegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.MillidegreeCelsiusPerSecond);

        /// <summary>
        ///     Get TemperatureChangeRate in NanodegreesCelsiusPerSecond.
        /// </summary>
        public decimal NanodegreesCelsiusPerSecond => As(TemperatureChangeRateUnit.NanodegreeCelsiusPerSecond);
        ...
        {
            decimal value = (decimal) centidegreescelsiuspersecond;
        ...
        {
            decimal value = (decimal) decadegreescelsiuspersecond;
        ...
        {
            decimal value = (decimal) decidegreescelsiuspersecond;
        ...
        {
            decimal value = (decimal) degreescelsiusperminute;
        ...
        {
            decimal value = (decimal) degreescelsiuspersecond;
        ...
        {
            decimal value = (decimal) hectodegreescelsiuspersecond;
        ...
        {
            decimal value = (decimal) kilodegreescelsiuspersecond;
        ...
        {
            decimal value = (decimal) microdegreescelsiuspersecond;
        ...
        {
            decimal value = (decimal) millidegreescelsiuspersecond;
        ...
        {
            decimal value = (decimal) nanodegreescelsiuspersecond;
        ...
        public static TemperatureChangeRate operator *(decimal left, TemperatureChangeRate right)
        {
            return new TemperatureChangeRate(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="TemperatureChangeRate"/> from multiplying value and <see cref="TemperatureChangeRate"/>.</summary>
        public static TemperatureChangeRate operator *(TemperatureChangeRate left, decimal right)
        {
        ...
        public static decimal operator /(TemperatureChangeRate left, TemperatureChangeRate right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(TemperatureChangeRate, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(TemperatureChangeRate left, TemperatureChangeRate right)
        {
        ...
        public bool Equals(TemperatureChangeRate other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        private decimal GetValueInBaseUnit()
        {
            switch(Unit)
            {
                case TemperatureChangeRateUnit.CentidegreeCelsiusPerSecond: return (_value) * 1e-2m;
                case TemperatureChangeRateUnit.DecadegreeCelsiusPerSecond: return (_value) * 1e1m;
                case TemperatureChangeRateUnit.DecidegreeCelsiusPerSecond: return (_value) * 1e-1m;
                case TemperatureChangeRateUnit.DegreeCelsiusPerMinute: return _value/60m;
                case TemperatureChangeRateUnit.DegreeCelsiusPerSecond: return _value;
                case TemperatureChangeRateUnit.HectodegreeCelsiusPerSecond: return (_value) * 1e2m;
                case TemperatureChangeRateUnit.KilodegreeCelsiusPerSecond: return (_value) * 1e3m;
                case TemperatureChangeRateUnit.MicrodegreeCelsiusPerSecond: return (_value) * 1e-6m;
                case TemperatureChangeRateUnit.MillidegreeCelsiusPerSecond: return (_value) * 1e-3m;
                case TemperatureChangeRateUnit.NanodegreeCelsiusPerSecond: return (_value) * 1e-9m;
                default:
        ...
        private decimal GetValueAs(TemperatureChangeRateUnit unit)
        {
            if(Unit == unit)
                return _value;
