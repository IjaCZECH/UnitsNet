...
namespace UnitsNet
{
    ...
    public partial struct LuminousFlux : IQuantity<LuminousFluxUnit>, IEquatable<LuminousFlux>, IComparable, IComparable<LuminousFlux>, IConvertible, IFormattable
    {
        ...
        public LuminousFlux(decimal value, LuminousFluxUnit unit)
        {
        ...
        public LuminousFlux(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static LuminousFlux MaxValue { get; } = new LuminousFlux(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of LuminousFlux
        /// </summary>
        public static LuminousFlux MinValue { get; } = new LuminousFlux(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal Lumens => As(LuminousFluxUnit.Lumen);
        ...
        {
            return new LuminousFlux((decimal)value, fromUnit);
        }
        ...
        public static LuminousFlux operator *(decimal left, LuminousFlux right)
        {
            return new LuminousFlux(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="LuminousFlux"/> from multiplying value and <see cref="LuminousFlux"/>.</summary>
        public static LuminousFlux operator *(LuminousFlux left, decimal right)
        {
        ...
        public static decimal operator /(LuminousFlux left, LuminousFlux right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(LuminousFlux, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(LuminousFlux left, LuminousFlux right)
        {
        ...
        public bool Equals(LuminousFlux other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        public decimal As(LuminousFluxUnit unit)
        {
            if(Unit == unit)
        ...
        private decimal GetValueAs(LuminousFluxUnit unit)
        {
            if(Unit == unit)
                return _value;
