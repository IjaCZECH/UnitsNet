...
namespace UnitsNet
{
    ...
    public partial struct Illuminance : IQuantity<IlluminanceUnit>, IEquatable<Illuminance>, IComparable, IComparable<Illuminance>, IConvertible, IFormattable
    {
        ...
        public Illuminance(decimal value, IlluminanceUnit unit)
        {
        ...
        public Illuminance(decimal value, UnitSystem unitSystem)
        {
        ...
        public static Illuminance operator *(decimal left, Illuminance right)
        {
            return new Illuminance(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="Illuminance"/> from multiplying value and <see cref="Illuminance"/>.</summary>
        public static Illuminance operator *(Illuminance left, decimal right)
        {
        ...
        public static decimal operator /(Illuminance left, Illuminance right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(Illuminance, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(Illuminance left, Illuminance right)
        {
        ...
        private decimal GetValueAs(IlluminanceUnit unit)
        {
            if(Unit == unit)
                return _value;
