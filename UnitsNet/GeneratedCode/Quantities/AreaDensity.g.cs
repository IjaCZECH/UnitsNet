...
namespace UnitsNet
{
    ...
    public partial struct AreaDensity : IQuantity<AreaDensityUnit>, IEquatable<AreaDensity>, IComparable, IComparable<AreaDensity>, IConvertible, IFormattable
    {
        ...
        public AreaDensity(decimal value, AreaDensityUnit unit)
        {
        ...
        public AreaDensity(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static AreaDensity MaxValue { get; } = new AreaDensity(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of AreaDensity
        /// </summary>
        public static AreaDensity MinValue { get; } = new AreaDensity(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal KilogramsPerSquareMeter => As(AreaDensityUnit.KilogramPerSquareMeter);
        ...
        {
            decimal value = (decimal) kilogramspersquaremeter;
        ...
        {
            return new AreaDensity((decimal)value, fromUnit);
        }
        ...
        public static AreaDensity operator *(decimal left, AreaDensity right)
        {
            return new AreaDensity(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="AreaDensity"/> from multiplying value and <see cref="AreaDensity"/>.</summary>
        public static AreaDensity operator *(AreaDensity left, decimal right)
        {
        ...
        public static decimal operator /(AreaDensity left, AreaDensity right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(AreaDensity, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(AreaDensity left, AreaDensity right)
        {
        ...
        public bool Equals(AreaDensity other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        public decimal As(AreaDensityUnit unit)
        {
            if(Unit == unit)
        ...
        private decimal GetValueAs(AreaDensityUnit unit)
        {
            if(Unit == unit)
                return _value;
