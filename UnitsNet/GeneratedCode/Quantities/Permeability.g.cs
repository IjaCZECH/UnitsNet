...
namespace UnitsNet
{
    ...
    public partial struct Permeability : IQuantity<PermeabilityUnit>, IEquatable<Permeability>, IComparable, IComparable<Permeability>, IConvertible, IFormattable
    {
        ...
        public Permeability(decimal value, PermeabilityUnit unit)
        {
        ...
        public Permeability(decimal value, UnitSystem unitSystem)
        {
        ...
        /// </summary>
        public static Permeability MaxValue { get; } = new Permeability(decimal.MaxValue, BaseUnit);

        /// <summary>
        /// Represents the smallest possible value of Permeability
        /// </summary>
        public static Permeability MinValue { get; } = new Permeability(decimal.MinValue, BaseUnit);
        ...
        /// </summary>
        public decimal HenriesPerMeter => As(PermeabilityUnit.HenryPerMeter);
        ...
        {
            decimal value = (decimal) henriespermeter;
        ...
        {
            return new Permeability((decimal)value, fromUnit);
        }
        ...
        public static Permeability operator *(decimal left, Permeability right)
        {
            return new Permeability(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="Permeability"/> from multiplying value and <see cref="Permeability"/>.</summary>
        public static Permeability operator *(Permeability left, decimal right)
        {
        ...
        public static decimal operator /(Permeability left, Permeability right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(Permeability, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(Permeability left, Permeability right)
        {
        ...
        public bool Equals(Permeability other, decimal tolerance, ComparisonType comparisonType)
        {
            if(tolerance < 0)
        ...
        public decimal As(PermeabilityUnit unit)
        {
            if(Unit == unit)
        ...
        private decimal GetValueAs(PermeabilityUnit unit)
        {
            if(Unit == unit)
                return _value;
