...
namespace UnitsNet
{
    ...
    public partial struct HeatTransferCoefficient : IQuantity<HeatTransferCoefficientUnit>, IEquatable<HeatTransferCoefficient>, IComparable, IComparable<HeatTransferCoefficient>, IConvertible, IFormattable
    {
        ...
        public HeatTransferCoefficient(decimal value, HeatTransferCoefficientUnit unit)
        {
        ...
        public HeatTransferCoefficient(decimal value, UnitSystem unitSystem)
        {
        ...
        public static HeatTransferCoefficient operator *(decimal left, HeatTransferCoefficient right)
        {
            return new HeatTransferCoefficient(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="HeatTransferCoefficient"/> from multiplying value and <see cref="HeatTransferCoefficient"/>.</summary>
        public static HeatTransferCoefficient operator *(HeatTransferCoefficient left, decimal right)
        {
        ...
        public static decimal operator /(HeatTransferCoefficient left, HeatTransferCoefficient right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(HeatTransferCoefficient, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(HeatTransferCoefficient left, HeatTransferCoefficient right)
        {
        ...
        private decimal GetValueAs(HeatTransferCoefficientUnit unit)
        {
            if(Unit == unit)
                return _value;
