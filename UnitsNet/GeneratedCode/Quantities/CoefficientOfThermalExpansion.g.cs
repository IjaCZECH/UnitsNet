...
namespace UnitsNet
{
    ...
    public partial struct CoefficientOfThermalExpansion : IQuantity<CoefficientOfThermalExpansionUnit>, IEquatable<CoefficientOfThermalExpansion>, IComparable, IComparable<CoefficientOfThermalExpansion>, IConvertible, IFormattable
    {
        ...
        public CoefficientOfThermalExpansion(decimal value, CoefficientOfThermalExpansionUnit unit)
        {
        ...
        public CoefficientOfThermalExpansion(decimal value, UnitSystem unitSystem)
        {
        ...
        public static CoefficientOfThermalExpansion operator *(decimal left, CoefficientOfThermalExpansion right)
        {
            return new CoefficientOfThermalExpansion(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="CoefficientOfThermalExpansion"/> from multiplying value and <see cref="CoefficientOfThermalExpansion"/>.</summary>
        public static CoefficientOfThermalExpansion operator *(CoefficientOfThermalExpansion left, decimal right)
        {
        ...
        public static decimal operator /(CoefficientOfThermalExpansion left, CoefficientOfThermalExpansion right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(CoefficientOfThermalExpansion, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(CoefficientOfThermalExpansion left, CoefficientOfThermalExpansion right)
        {
        ...
        private decimal GetValueAs(CoefficientOfThermalExpansionUnit unit)
        {
            if(Unit == unit)
                return _value;
