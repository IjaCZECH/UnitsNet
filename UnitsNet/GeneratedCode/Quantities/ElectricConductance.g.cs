...
namespace UnitsNet
{
    ...
    public partial struct ElectricConductance : IQuantity<ElectricConductanceUnit>, IEquatable<ElectricConductance>, IComparable, IComparable<ElectricConductance>, IConvertible, IFormattable
    {
        ...
        public ElectricConductance(decimal value, ElectricConductanceUnit unit)
        {
        ...
        public ElectricConductance(decimal value, UnitSystem unitSystem)
        {
        ...
        public static ElectricConductance operator *(decimal left, ElectricConductance right)
        {
            return new ElectricConductance(left * right.Value, right.Unit);
        }

        /// <summary>Get <see cref="ElectricConductance"/> from multiplying value and <see cref="ElectricConductance"/>.</summary>
        public static ElectricConductance operator *(ElectricConductance left, decimal right)
        {
        ...
        public static decimal operator /(ElectricConductance left, ElectricConductance right)
        {
        ...
        /// <remarks>Consider using <see cref="Equals(ElectricConductance, decimal, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(ElectricConductance left, ElectricConductance right)
        {
        ...
        private decimal GetValueAs(ElectricConductanceUnit unit)
        {
            if(Unit == unit)
                return _value;
