...
namespace UnitsNet
{
    public partial struct BrakeSpecificFuelConsumption
    {
        ...
        public static SpecificEnergy operator /(decimal value, BrakeSpecificFuelConsumption bsfc)
        {
        ...
        public static decimal operator *(BrakeSpecificFuelConsumption bsfc, SpecificEnergy specificEnergy)
        {
