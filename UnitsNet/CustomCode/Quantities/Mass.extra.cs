...
namespace UnitsNet
{
    public partial struct Mass
    {
        ...
        /// </summary>
        private const decimal StonesInOnePound = 14.0m;
        ...
        /// </summary>
        public static Mass FromStonePounds(decimal stone, Decimal pounds)
        {
        ...
        {
            return MassFlow.FromKilogramsPerSecond(mass.Kilograms / (decimal)timeSpan.TotalSeconds);
        }
    ...
    public sealed class StonePounds
    {
        ...
        /// </summary>
        public StonePounds(decimal stone, decimal pounds)
        {
            Stone = stone;
            Pounds = pounds;
        }
