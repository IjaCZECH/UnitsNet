...
namespace UnitsNet
{
    public partial struct AmplitudeRatio
    {
            ...
            : this()
        {
            ...
            _value = 20 * DecimalMath.DecimalEx.Log10(voltage.Volts / 1);
        ...
        {
            // E(V) = 1V * 10^(E(dBV)/20)
            return ElectricPotential.FromVolts(DecimalMath.DecimalEx.Pow(10, DecibelVolts / 20));
        }
        ...
        public PowerRatio ToPowerRatio(ElectricResistance impedance)
        {
            ...
            return PowerRatio.FromDecibelWatts(DecibelVolts - 10 * DecimalMath.DecimalEx.Log10(impedance.Ohms / 1));
        }
