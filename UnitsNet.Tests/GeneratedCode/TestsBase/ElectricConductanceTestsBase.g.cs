...
// ReSharper restore VirtualMemberNeverOverriden.Global
        ...
        {
            Assert.Throws<ArgumentException>(() => new ElectricConductance((decimal)0.0, ElectricConductanceUnit.Undefined));
        }
...
// ReSharper restore EqualExpressionComparison
        ...
        public void ToString_SFormat_FormatsNumberWithGivenDigitsAfterRadixForCurrentCulture()
        {
            ...
            try
            {
                ...
                Assert.Equal("0.1 S", new ElectricConductance(0.123456m, ElectricConductanceUnit.Siemens).ToString("s1"));
                Assert.Equal("0.12 S", new ElectricConductance(0.123456m, ElectricConductanceUnit.Siemens).ToString("s2"));
                Assert.Equal("0.123 S", new ElectricConductance(0.123456m, ElectricConductanceUnit.Siemens).ToString("s3"));
                Assert.Equal("0.1235 S", new ElectricConductance(0.123456m, ElectricConductanceUnit.Siemens).ToString("s4"));
            }
            finally
            {
        ...
        public void ToString_SFormatAndCulture_FormatsNumberWithGivenDigitsAfterRadixForGivenCulture()
        {
            ...
            Assert.Equal("0.1 S", new ElectricConductance(0.123456m, ElectricConductanceUnit.Siemens).ToString("s1", culture));
            Assert.Equal("0.12 S", new ElectricConductance(0.123456m, ElectricConductanceUnit.Siemens).ToString("s2", culture));
            Assert.Equal("0.123 S", new ElectricConductance(0.123456m, ElectricConductanceUnit.Siemens).ToString("s3", culture));
            Assert.Equal("0.1235 S", new ElectricConductance(0.123456m, ElectricConductanceUnit.Siemens).ToString("s4", culture));
        }
